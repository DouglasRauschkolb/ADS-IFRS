...
public class TesteListaDuplamenteLigada {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Primeiro da lista: " + lista.pega(0).toString());
        ...
        System.out.println("Existe na lista: " + lista.contem(carro3));
